...
const otherContributions: Contribution[] = [
  ...
  { id: 'CONFEB01', memberId: 'MEM049', memberName: 'Dan Mugah', date: '2026-02-01', amount: 300, method: 'Paybill' },
  { id: 'CONFEB02', memberId: 'MEM001', memberName: 'Kepher Otieno', date: '2026-02-01', amount: 300, method: 'Paybill' },
  { id: 'CONFEB03', memberId: 'MEM005', memberName: 'Caroline Dima', date: '2026-02-01', amount: 300, method: 'Paybill' },
...
export const welfareRequests: WelfareRequest[] = [
  { id: 'WEL001', memberId: 'MEM013', memberName: 'Lucy Ombuga', requestDate: '2026-01-20', amount: 500, reason: 'Medical Emergency', status: 'Approved' },
  { id: 'WEL002', memberId: 'MEM012', memberName: 'Felix Odera', requestDate: '2026-01-25', amount: 1000, reason: 'Education Fund', status: 'Disbursed' },
  { id: 'WEL003', memberId: 'MEM024', memberName: 'Claris Adhiambo', requestDate: '2026-02-01', amount: 750, reason: 'Home Repair', status: 'Pending' },
  { id: 'WEL004', memberId: 'MEM035', memberName: 'Asha Okoth', requestDate: '2026-02-01', amount: 200, reason: 'Family Support', status: 'Rejected' },
  { id: 'WEL005', memberId: 'MEM044', memberName: 'Chris Mugah', requestDate: '2026-02-02', amount: 1200, reason: 'Bereavement', status: 'Pending' },
];
